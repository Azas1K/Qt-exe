...
#include <memory>
#include "../../../src/ex_modelview/addrowdialog.h"
...
QT_MOC_LITERAL(1, 13, 12), // "saveAddedRow"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "AddRowDialog\0saveAddedRow\0"
};
...
void AddRowDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AddRowDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->saveAddedRow(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
